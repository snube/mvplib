package com.snubee.widget.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mConf.setRadius(ta.getInt(R.styleable.SwitchButton_swRadius, Configuration.Default.DEFAULT_RADIUS));
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mClickBackListener != null) {
                    mClickBackListener.onCallBack(mIsChecked);
                }

                if (deltaX < mTouchSlop && deltaY < mTouchSlop && time < mClickTimeout) {
//                    if (!isAuto) return true;
                    performClick();
                    Log.e("snubee", "------------------1" + mIsChecked);
                } else {
                    Log.e("snubee", "------------------2" + mIsChecked);
                    slideToChecked(nextStatus);
                    Log.e("snubee", "------------------3" + mIsChecked);
//                    if (!isAuto)
//                        setChecked(!mIsChecked);
                    Log.e("snubee", "------------------4" + mIsChecked);
                }
                break;
    ...
    public void setOnClickBackListener(OnClickBackListener l) {
        this.mClickBackListener = l;
    }
    ...
    public interface OnClickBackListener {
        void onCallBack(boolean checked);
    }
}
